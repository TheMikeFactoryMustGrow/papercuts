...
No shell and no file write either (plain chat surface)? Do not drop the papercut:
state it verbatim in your reply, flagged `PAPERCUT:`, so the user or a shelled
session can log it properly later.
<!-- agent-papercuts:end -->
